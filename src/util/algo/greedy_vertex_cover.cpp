...
template vector<int32_t> greedy_vertex_cover<int32_t>(FlatArray<Edge<int32_t>>& neighbors, const SuperBlockId* member_counts, bool merge_recursive, bool, int32_t);
template vector<int64_t> greedy_vertex_cover<int64_t>(FlatArray<Edge<int64_t>>& neighbors, const SuperBlockId* member_counts, bool merge_recursive, bool, int64_t);
